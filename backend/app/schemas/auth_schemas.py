...
class ResgistrySchema(Schema):
    ...
    def validate_password_strength(self, value):
        ...
        if not any(char.islower() for char in value):
            errorMessages.append("Le mot de passe doit contenir au moins une lettre minuscule")
        if not any(char.isupper() for char in value):
            errorMessages.append("Le mot de passe doit contenir au moins une lettre majuscule")
        if not any(char.isdigit() for char in value):
            errorMessages.append("Le mot de passe doit contenir au moins un chiffre")
        if not any(char in "!@#$%^&*()_+-=[]{}|;:,.<>?/" for char in value):
            errorMessages.append("Le mot de passe doit contenir au moins un caractère spécial")
    ...
    def validate_username(self, value):
        ...
        if len(value) > 20:
            errorMessages.append(
                "Le username ne peux pas avoir plus de 20 charactères"
            )
